const resumeContent = {
  ...
  en: {
    ...
    // EDUCATION
    edu1Title:
      "Bachelor of Engineering in Information and Communications Technology (ICT)",
    edu1Dates: "08.2023 – 05.2027",
    edu1School:
      "Metropolia University of Applied Sciences, Helsinki (Transfer from Turku AMK)",
    ...
    skillLangList:
      "JavaScript (ES6+), Python, HTML, CSS, Shell Scripting, Advanced Data Structures & Algorithms.",
  ...
  sv: {
    ...
    // EDUCATION
    edu1Title:
      "Högskoleingenjör i Informations- och Kommunikationsteknik (ICT)",
    edu1Dates: "Aug 2023 – Maj 2027",
    edu1School:
      "Yrkeshögskolan Metropolia, Helsingfors (Överflyttad från Turku AMK)",
    ...
    infoLangText:
      "Modersmål i fyra språk: svenska, finska, svenskt teckenspråk och finskt teckenspråk (föräldrar är döva, jag är hörande). Jag är därtill flytande i engelska.",
    infoSportTitle: "Idrott",
    infoSportText:
      "Jag har tidigare tävlat i basket. Denna bakgrund har gett mig en disciplinerad arbetsmoral, uthållighet och stark tidsplaneringsförmåga, som är avgörande för att balansera krävande studier och projektleveranser.",
  },
};
